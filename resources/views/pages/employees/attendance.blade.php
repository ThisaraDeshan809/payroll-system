    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('/employees/attendance') }}">Attendance</a></li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-3">
                <button type="button" class="btn btn-secondary btn-lg m-1" id="btn_upload_employees" data-bs-toggle="modal"
                    data-bs-target="#attendanceUploadModal"><i class="fa-solid fa-file-excel"></i> Upload Monthly
                    Attendance</button>
            </div>

            <div class="col-md-3">
                <button type="button" class="btn btn-warning btn-lg m-1" id="btn_show_incomplete"><i
                        class="fa-solid fa-eye"></i> Show Incomplete Attendances</button>
            </div>

            <div class="col-md-12 mt-4 mb-4">
                <h2><span id="tbl_head">Attendance Details</span></h2>
                <table class="table table-hover" style="width: 100%;" id="tbl_attendance">
                    <thead>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn_show_incomplete').on('click', function(e) {
                e.preventDefault();

                $('#tbl_head').text('Incompleted Attendances')

                // Check if DataTable is already initialized and destroy it if needed
                if ($.fn.DataTable.isDataTable('#tbl_attendance')) {
                    $('#tbl_attendance').DataTable().destroy();
                }

                // Reinitialize the DataTable
                tbl_incomplete_employees = $('#tbl_attendance').DataTable({
                    lengthMenu: [
                        [25, 50, 100, -1],
                        ['25 ', '50 ', '100', 'All']
                    ],
